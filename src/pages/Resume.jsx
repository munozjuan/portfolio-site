...
export default function Resume() {
  return (
    <FadeWrapper>
      <section className="bg-[#1C1C1C] text-white pt-28 pb-16 px-4 sm:px-8 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-block mt-6 bg-[#FFA629] text-black px-6 py-3 rounded-lg font-medium hover:bg-[#e6951f] transition"
        >
          Download Resume
        </a>
      </section>
